...
counter = 0
while not(path.exists('cla_'+monsternr+'_report.csv') and path.exists('kra_'+monsternr+'_report.csv') and path.exists('kai_'+monsternr+'_report.csv')) or counter >= 20:
...
cla_df.columns = ['clark_name','b','c','d','clark_result','f']
...
print()
#.sort_values(by='clark_result', ascending=False, ignore_index=True)
#print(cla_head5_sorted)
print("....")
...
cdf.to_csv('results/combined_'+monsternr+'_file.csv')
